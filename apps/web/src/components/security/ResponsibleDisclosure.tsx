  ...
  return (
    <section id="disclosure" className="py-20 sm:py-28" aria-labelledby="disclosure-heading">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <Reveal>
          <div className="relative overflow-hidden rounded-[10px] border border-line bg-surface/60 px-6 py-10 sm:px-12 sm:py-12">
            {/* Subtle corner glow */}
            ...
            <div className="relative flex flex-col items-start gap-8 md:flex-row md:items-center">
              ...
              <div className="md:ml-auto">
                <a
                  ...
                  className="inline-flex h-11 items-center justify-center gap-2 rounded-md border border-line bg-raised px-6 text-sm font-medium text-fg transition-colors duration-200 hover:border-line-strong hover:bg-hover"
                >
